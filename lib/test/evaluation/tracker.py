...
class Tracker:
    ...
    def run_sequence(self, seq, debug=None):
        ...
        tracker.init_seq_name(seq.name)
    ...
    def _track_sequence(self, tracker, seq, init_info):
        ...
        for frame_num, (frame_path, text) in enumerate(zip(seq.frames[1:], seq.texts[1:]), start=1):
            ...
            out = tracker.track(image, text, info)
            prev_output = OrderedDict(out)
    ...
    def get_parameters(self, tracker_params=None):
        ...
        params = param_module.parameters(self.parameter_name, model)
